...
CREATE INDEX IDX_TLS231_INPADOC_LEGAL_EVENT_appln_id ON TLS231_IPADOC_LEGAL_EVENT
(appln_id);

CREATE INDEX IDX_TLS231_INPADOC_LEGAL_EVENT_event_seq_nr ON TLS231_IPADOC_LEGAL_EVENT
(event_seq_nr);
