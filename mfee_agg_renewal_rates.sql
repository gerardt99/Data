...
SELECT * FROM DW.ALL_PAT_CASE a WHERE a.INV_CD = 'UTL';
...
--Calculate Annual Renewal Rates
SELECT TRUNC(a.ISS_DA, 'YEAR') "Year_Patent_Granted", 
COUNT(UNIQUE(a.SER_NO)) "Patent_Count",
ROUND(COUNT(CASE WHEN b.ENTRY_CD IN 
      ('M1551','M170','M173','M183','M2551','M273','M283','M3551') 
      THEN 1 ELSE NULL END)/COUNT(UNIQUE(a.SER_NO)),4) "1st_renewal_rate",
...
AND a.ISS_DA > TO_DATE('09-30-1989', 'MM-DD-YYYY')
AND a.Pat_No Not LIKE 'D%'
GROUP BY TRUNC(a.ISS_DA, 'YEAR')
ORDER BY TRUNC(a.ISS_DA, 'YEAR') DESC;

--Calculate Annual Renewal Rates by USPC
SELECT TRUNC(a.ISS_DA, 'YEAR') "Year_Patent_Granted", 
a.US_PAT_CLASS_CD "USPC Class",
COUNT(UNIQUE(a.SER_NO)) "Patent_Count",
ROUND(COUNT(CASE WHEN b.ENTRY_CD IN 
      ('M1551','M170','M173','M183','M2551','M273','M283','M3551') 
      THEN 1 ELSE NULL END)/COUNT(UNIQUE(a.SER_NO)),4) "1st_renewal_rate",
...
AND a.ISS_DA > TO_DATE('09-30-1989', 'MM-DD-YYYY')
AND a.Pat_No Not LIKE 'D%'
GROUP BY TRUNC(a.ISS_DA, 'YEAR'),a.US_PAT_CLASS_CD
ORDER BY TRUNC(a.ISS_DA, 'YEAR'),a.US_PAT_CLASS_CD DESC;

--Calculate Monthly Renewal Rates by USPC
SELECT TRUNC(a.ISS_DA, 'MON') "Year_Patent_Granted", 
a.US_PAT_CLASS_CD "USPC Class",
COUNT(UNIQUE(a.SER_NO)) "Patent_Count",
ROUND(COUNT(CASE WHEN b.ENTRY_CD IN 
      ('M1551','M170','M173','M183','M2551','M273','M283','M3551') 
...
AND a.ISS_DA > TO_DATE('09-30-1989', 'MM-DD-YYYY')
AND a.Pat_No Not LIKE 'D%'
GROUP BY TRUNC(a.ISS_DA, 'MON'),a.US_PAT_CLASS_CD
ORDER BY TRUNC(a.ISS_DA, 'MON'),a.US_PAT_CLASS_CD DESC;